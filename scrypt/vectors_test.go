// This file is a modified copy of the scrypt_test.go from crypto/scrypt
// which had/has the following copyright:
...
var bad = []testVector{
	...
	{"p", "s", 16, math.MaxInt32 / 2, math.MaxInt32 / 2, nil}, // p * r too large
}
